                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col" class="px-4 py-4">Nombre del servicio</th>
                                    <th scope="col" class="px-4 py-3">Costo del servicio</th>
                            ...
                            <tbody>
                                <tr v-for="cita in listado" class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ cita.servicio }}</th>

                                    <td class="px-4 py-3 max-w-[12rem] truncate">$ {{ cita.costo }}</td>
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form action="#">
                    ...
                    <div class="flex items-center space-x-4">
                        <button type="submit"
                            class="text-white bg-indigo-900 hover:bg-sky-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Update
                            product</button>
                        <button type="button"
