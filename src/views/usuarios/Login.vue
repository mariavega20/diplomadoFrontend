        ...
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                <div class="hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
                    <svg id="" data-name="Layer 1" xmlns="" width="100%" height="auto" viewBox="0 0 744.84799 747.07702">
                ...
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-l font-semibold px-1">Correo Electronico</label>
                            <div class="flex">
                                <div
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            <label for="" class="text-l font-semibold px-1">Contraseña</label>
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button
                                class="block w-full max-w-xs mx-auto bg-blue-700 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Login</button>
                        </div>
                    </div>
                </div>
            </div>
